...
// 				{ field: 'id', filter: FilterType.EQ, value: warehouseId }
// 			]
// 		});
...
import type { Warehouse } from '$lib/interfaces/warehouse.interface.js';
...
export const load = async ({ locals: { supabase } }) => {
	...
	return { addProductsform, warehouses } as { warehouses: Array<Warehouse>; addProductsform: any };
};
